                    ...
                    <div className="space-y-3">
                        ...
                        (doc: File | null, index: number) => (
                          <div key={index} className="flex items-center gap-3">
                            <input
                              ...
                              className="flex-1 rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#01A2EE] focus:ring-[#01A2EE] focus:outline-none"
                            />
                            <input
                              type="text"
                              placeholder="Description (optional)"
                              value={''} // No description field in the form state, so this will be empty
                              onChange={() => {
                                // No description field in the form state, so this will do nothing
                              }}
                              className="flex-1 rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#01A2EE] focus:ring-[#01A2EE] focus:outline-none"
                            />
                            <button
                      ...
                      <button
                        ...
                        onClick={() => {
                          const newDocs = [
                            ...(formData.additionalDocuments || []),
                            null, // Add a null file to allow adding more
                          ]
                          setFormData((prev) => ({
                            ...prev,
                            additionalDocuments: newDocs,
